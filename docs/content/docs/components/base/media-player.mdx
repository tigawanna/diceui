...
links:
  ...
  api: /docs/components/base/media-player#api-reference
---
...
<Step>After completing the prerequisite component updates, install the required dependencies:</Step>

```package-install
@base-ui/react react-dom @radix-ui/react-tooltip lucide-react
```
...
<AutoTypeTable
  path="./types/base/media-player.ts"

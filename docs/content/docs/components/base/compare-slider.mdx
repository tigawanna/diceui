...
preview: false
links:
  api: /docs/components/base/compare-slider#api-reference
---
...
```package-install
@base-ui/react react-dom lucide-react
```

<Step>Copy and paste the refs composition utilities into your `components/compose-refs.ts` file.</Step>
...
<AutoTypeTable
  path="./types/base/compare-slider.ts"

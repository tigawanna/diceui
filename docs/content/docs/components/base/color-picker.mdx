...
preview: false
links:
 api: /docs/components/base/color-picker#api-reference
---
...
```package-install
@base-ui/react react-dom @radix-ui/react-popover @radix-ui/react-select lucide-react
```
...
<AutoTypeTable
  path="./types/base/color-picker.ts"

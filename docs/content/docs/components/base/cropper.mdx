...
preview: false
links:
 api: /docs/components/base/cropper#api-reference
---
...
<KeyboardShortcutsTable
  data={[
    ...
    },
    {
      ...
      description: "Moves the crop area with finer precision (20% of keyboard step).",
    },
  ]}
/>
